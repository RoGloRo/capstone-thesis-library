    ...
    <footer className="mt-12">
      <div className="container mx-auto px-4">
        <div className="text-center text-sm text-ink-muted dark:text-slate-400">
          ...
          <span className="mx-2">|</span>
          <Link href="/about-us#contact-us" className="text-ink hover:text-green-700 dark:text-slate-300 dark:hover:text-slate-100 hover:underline transition-colors duration-150">Contact Us</Link>
        </div>
      </div>
    </footer>
  )
